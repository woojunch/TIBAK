...
public class AccomodationSerachCommand {
	   private String aProKind;
	   private int aProPrice;
	   private int aProPriceM;
	   private int aProPrices;
	   private int aProPricesM;
	...
	public int getaProPriceM() {
		return aProPriceM;
	}
	public void setaProPriceM(int aProPriceM) {
		this.aProPriceM = aProPriceM;
	}
	...
	public int getaProPricesM() {
		return aProPricesM;
	}
	public void setaProPricesM(int aProPricesM) {
		this.aProPricesM = aProPricesM;
	}
